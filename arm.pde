...
void draw(){
  ...
  popMatrix();
  translate(0,pillarD-pillarB1/2,-pillarH/2);
  box(pillarB1,pillarB1,pillarH);
  translate(0,pillarB1/2,-7*pillarH/16);
  box(pillarB1,pillarB2,pillarH/8);
  ...
  translate(-pillarD,0,0);
  box(pillarD,pillarB1,pillarB1);
  
  translate(pillarD/2,pillarD/2,0);
  box(pillarB1,pillarD,pillarB1);
  
  translate(0,-pillarD,0);
  box(pillarB1,pillarD,pillarB1);
